...
public final class WebSecurityUrls {
    ...
    public static final String[] PUBLIC_ENDPOINTS = {"/service"};
    public static final String[] ANONYMOUS_ENDPOINTS = {"/user/**"};
    public static final String[] AUTHENTICATED_ENDPOINTS = {"/admin"};
