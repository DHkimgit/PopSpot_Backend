...
public class AccessTokenProvider implements JwtProvider {
    ...
    public JwtClaims getJwtClaimsFromToken(String token) {
        ...
        return AccessTokenClaim.of(Integer.parseInt(claims.get(AccessTokenClaimKeys.USER_ID.getValue(), String.class)), claims.get(
            AccessTokenClaimKeys.ROLE.getValue(), String.class));
    }
